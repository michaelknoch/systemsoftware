...
def runQemu():
	# TODO: -dtb
	os.system('qemu-system-arm -m 10 -M vexpress-a9 -kernel linux-4.2.3/arch/arm/boot/zImage -nographic -serial stdio -dtb linux-4.2.3/arch/arm/boot/dts/vexpress-v2p-ca9.dtb -monitor telnet:127.0.0.1:2222,server,nowait -append "console=ttyAMA0" -initrd ./initramfs_data.cpio.gz -net nic,macaddr=00:00:00:00:F1:01,vlan=0 -net vde,sock="/tmp/vde2-tap0.ctl",vlan=0')
